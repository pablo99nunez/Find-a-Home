...
export default function Condition({ ConditionName, HandleCheck, checkState }) {
    return (
        <TouchableOpacity onPress={() => HandleCheck(ConditionName)} className={checkState[ConditionName] ? "mt-3 self-start mx-14 rounded-full bg-[#AB4E68] p-2" : 'mt-3 self-start mx-14 rounded-full bg-[#d9d9d971] p-2'}>
