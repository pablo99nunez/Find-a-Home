  ...
  const HandleSubmit = async () => {
    if (!error.name && !error.description && !error.birthday) {
      const DatosPetAEnviar = {
        ...
        size: crear.size,
        profilePic: crear.galeria[0] || 'https://us.123rf.com/450wm/natbasil/natbasil1601/natbasil160100031/52068222-animales-siluetas-perro-gato-y-conejo-logotipo-de-la-tienda-de-animales-o-cl%C3%ADnica-veterinaria-ilustr.jpg?ver=6',
  ...
  return (
    <>
      <ScrollView className='bg-[#d9d9d9]' >
        <FormPet setCrear={setCrear} crear={crear} error={error} setError={setError}/>
